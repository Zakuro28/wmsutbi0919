        ...
        <form id="register-frm" action="" method="post">
          ...
          <div class="row">
            <div class="form-group col-md-12">
              ...
              <textarea name="address" id="address" rows="3" class="form-control form-control-sm rounded-0" placeholder="Block 6 Lot 12, A&W Subd., Zamboanga City, Zamboanga del Sur, 7000"></textarea>
            </div>
          </div>
          <hr>
          <div class="row">
            <div class="form-group col-md-6">
                <input type="email" name="email" id="email" placeholder="zakurofr@sample.com" class="form-control form-control-sm form-control-border" required>
